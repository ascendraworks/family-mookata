...
import { motion, AnimatePresence } from 'framer-motion'; // Added for Framer Motion
...
const priceItems = [
  { title: "Meat Buffet Platter", description: "$14.90 - Extremely competitive and worthy.", imgSrc: "/img/heronobg.png" }, // Updated
  { title: "Seafood Buffet Platter", description: "$19.90 - Extremely competitive and worthy.", imgSrc: "/img/heronobg.png" }, // Updated
  { title: "Your Custom Set", description: "Create your perfect mookata experience!", imgSrc: "/img/heronobg.png" }, // Template
];

const reviews = [
  {
    name: "Sheila Cheong",
    // avatarSrc: "/img/avatar-sheila.jpg", // Removed, will use default icon
    rating: 5,
  ...
  {
    name: "Namita Sinha",
    // avatarSrc: "/img/avatar-michael.jpg", // Removed
    rating: 4,
  ...
  {
    name: "Alex Ho",
    // avatarSrc: "/img/avatar-aisha.jpg", // Removed
    rating: 5,
  ...
  {
    name: "Valefor Ho",
    rating: 5, // Assuming a 5-star rating, adjust if needed
    ...
    foodImgSrc: "/img/valefor.jpg", // Placeholder, replace with actual image path
  },
  {
    name: "rachel tang",
    rating: 5, // Assuming a 5-star rating, adjust if needed
    ...
    foodImgSrc: "/img/rachel.jpg", // Placeholder, replace with actual image path
  },
];
...
// Component for handling expandable review text
...
export default function HomePage() {
  ...
  // const [openMobileLocation, setOpenMobileLocation] = useState<string | null>(null); // Replaced by activeCardIndex
  // const toggleMobileLocation = (locationName: string) => {
  //   setOpenMobileLocation(openMobileLocation === locationName ? null : locationName);
  // };
  ...
  return (
    <div className="bg-white text-[#333333]">
      {/* Hero Section */}
      <section className="relative container mx-auto px-4 sm:px-6 lg:px-8 pb-20 md:pb-32 overflow-hidden min-h-[calc(80vh)] md:min-h-[calc(90vh)] flex items-center pt-8 md:pt-12"> {/* Reduced top padding significantly */}
        ...
        <div className="absolute top-1/2 left-1/4 transform translate-x-[-25%] translate-y-[-150%] md:translate-x-[-50%] md:translate-y-[-50%] opacity-100 md:opacity-70">
          <div className="w-[350px] h-[350px] sm:w-[450px] sm:h-[450px] md:w-[550px] md:h-[550px] lg:w-[650px] lg:h-[650px] bg-orange-100 rounded-full blur-3xl"></div> {/* Slightly adjusted size and blur */}
        </div>

        <div className="relative z-10 grid md:grid-cols-2 gap-8 md:gap-16 lg:gap-24 items-center w-full"> {/* Increased gap */}
          <div className="text-center md:text-left flex flex-col"> {/* Added flex flex-col for better control */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-black italic mb-4 md:mb-6"> {/* Removed whitespace-nowrap, Adjusted margin */}
              Family Mookata
            </h1>
            <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-black italic mb-8 md:mb-12"> {/* Adjusted size and margin */}
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10 md:mb-14 justify-center md:justify-start"> {/* Adjusted margin */}
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-x-6 sm:gap-x-10 md:gap-x-8 lg:gap-x-12 xl:gap-x-16 gap-y-4 sm:gap-y-5 text-black justify-center md:justify-start font-semibold italic"> {/* Adjusted gaps */}
              <div className="flex items-center">
                <Star className="h-5 w-5 sm:h-6 md:h-7 lg:h-8 text-[#FFB24F] mr-2 md:mr-3" />
                <span className="text-sm sm:text-base md:text-lg lg:text-xl font-bold">3.9K+ Reviews</span> {/* Adjusted sizes */}
              </div>
              <div className="flex items-center">
                <MapPin className="h-5 w-5 sm:h-6 md:h-7 lg:h-8 text-[#FFB24F] mr-2 md:mr-3" />
                <span className="text-sm sm:text-base md:text-lg lg:text-xl font-bold">3 Locations</span> {/* Adjusted sizes */}
              </div>
              <div className="flex items-center">
                <Clock className="h-5 w-5 sm:h-6 md:h-7 lg:h-8 text-[#FFB24F] mr-2 md:mr-3" />
                <span className="text-sm sm:text-base md:text-lg lg:text-xl font-bold">1PM – 11PM</span> {/* Adjusted sizes */}
              </div>
            </div>
          </div>
          <div className="relative w-full h-80 md:h-[550px] lg:h-[600px] mt-10 md:mt-0 flex items-center justify-center">
            <div className="absolute inset-0 flex items-center justify-center">
              <Image
                src="/img/heronobg.png" // This should be your image with the splashes
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row w-full md:h-[340px] gap-6 md:gap-2.5"> {/* Stacks on mobile, flex row on md+ */}
            ...
            <div className="md:hidden relative w-full h-[350px] flex items-center justify-center overflow-hidden px-10"> {/* Added px-10 for button spacing */}
              <AnimatePresence initial={false}> {/* Set initial={false} for smoother first appearance if needed */}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-3 flex-grow flex flex-col justify-between">
                        ...
                        {isActive && ( // Only show description and button if card is active (topmost)
                          <>
                            ...
                            <a
                              ...
                              onClick={(e) => e.stopPropagation()} // Prevent card tap when clicking link
