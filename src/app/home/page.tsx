                ...
                <div className="flex flex-col max-lg:text-center relative">
                    ...
                    <div className="flex gap-8 max-lg:justify-center z-10">
                        ...
                        <Button
                            ...
                            size="lg"
                        >
                            <a href="https://familymookata.eposqr.com/">Place Delivery Order</a>
                        </Button>
                    </div>
                            ...
                            <div className="bg-[#FFE6C6] flex rounded-2xl mx-12 px-12 pt-16 pb-12 gap-12 max-lg:gap-8 max-lg:flex-col max-sm:mx-4 max-sm:px-8">
                                    ...
                                    <div className="flex flex-col items-center gap-4 flex-grow">
                                        ...
                                        <div className="w-full bg-[#FFF7ED] rounded-lg py-4 px-6 flex flex-col gap-3 mt-4">
                                            <div>
                                                ...
                                                <p>Adult: <span className="font-bold">$14.90</span> | Kid (5–12): <span className="font-bold">$9.90</span></p>
                                            </div>
                                            <div>
                                                <p className="font-semibold">Peak (After 7PM, Weekends & PH)</p>
                                                <p>Adult: <span className="font-bold">$16.90</span> | Kid (5–12): <span className="font-bold">$11.90</span></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="w-1/3 flex flex-col bg-white rounded-xl shadow-lg px-8 py-8 max-lg:w-full">
                                    <div className="flex flex-col items-center gap-4 flex-grow">
                                        ...
                                        <div className="w-full bg-[#FFF7ED] rounded-lg py-4 px-6 flex flex-col gap-3 mt-4">
                                            <p>Adult: <span className="font-bold">$19.90</span></p>
                                            <p>Kid (5–12): <span className="font-bold">$14.90</span></p>
                                        </div>
                                    </div>
